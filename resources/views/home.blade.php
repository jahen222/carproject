...
<head>
	...
	<link rel="stylesheet" href="{{ asset('carproject/css/header.css') }}">
	<link rel="stylesheet" href="{{ asset('carproject/css/main.css') }}">
	<link rel="stylesheet" href="{{ asset('carproject/css/footer.css') }}">
</head>
<body>
	<header class="container-fluid">
		<div class="header row">
			...
			<div class="col-md-6 text-center">
				<img class="logo" src="{{ asset('carproject/img/logo.png') }}">
				<form>
			...
			<div class="col-md-3">
				<nav class="nav navbar">
					...
					<a class="nav-link" href="#"><img src="{{ asset('carproject/img/carrito.png') }}"></a>
				</nav>
			</div>
		</div>
		<!--
	...
	<section id="main-slider" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="{{ asset('carproject/img/main-slider/home.jpg') }}" class="d-block w-100" alt="Sistema de escape takataka">
				<span>Sistema de<br>escape takataka</span>
			</div>
			<div class="carousel-item">
				<img src="{{ asset('carproject/img/main-slider/JeepWrangler.jpg') }}" class="d-block w-100">
				<span>Sistema de<br>escape takataka</span>
			</div>
			<div class="carousel-item">
				<img src="{{ asset('carproject/img/main-slider/home25.jpg') }}" class="d-block w-100">
				<span>Sistema de<br>escape takataka</span>
			</div>
			<div class="carousel-item">
				<img src="{{ asset('carproject/img/main-slider/home26.jpg') }}" class="d-block w-100">
				<span>Sistema de<br>escape takataka</span>
			</div>
		</div>
	...
	<section class="container-fluid home-tienda">
		<div class="row">
			<div class="col-md-6">
				<img src="{{ asset('carproject/img/toyota.png') }}">
			</div>
	...
	<section class="home-publicidad">
		<img src="{{ asset('carproject/img/publicidad.jpg') }}" width="100%">
	</section>
	<section id="event-slider" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="{{ asset('carproject/img/event-slider/event1.jpg') }}" class="d-block w-100">
				<div class="card">
					<div class="card-body">
			...
			<div class="carousel-item">
				<img src="{{ asset('carproject/img/event-slider/event2.jpg') }}" class="d-block w-100">
			</div>
		</div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-4 img-logo">
					<img src="{{ asset('carproject/img/logo-white.png') }}">
				</div>
				<div class="w-100"></div>
				<div class="col-md-4">
		...
		<div class="row">
			<div class="col-md-7">
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6"><img src="{{ asset('carproject/img/paypal.png') }}"></div>
				</div>
				<div class="row">
					<div class="col-auto">
			...
			<div class="col-md align-content-center text-center">
				<a href="#"><img src="{{ asset('carproject/img/logo-white.png') }}"></a>
			</div>
		</div>
	</footer>
	...
	<script type="text/javascript" src="{{ asset('carproject/js/custom.js') }}"></script>
</body>
</html>
